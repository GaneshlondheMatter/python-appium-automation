...
class LoginHelper:
    ...
    def login_into_matterverse(driver):
        ...
        try:
            ...
            # 4️⃣ Wait for OTP screen and enter OTP
            print("\nStep 4: Waiting for OTP screen...")
            # Wait a moment for OTP screen to appear
            time.sleep(3)
            ...
            # 6️⃣ Verify login success (optional - add your verification)
            print("\nStep 6: Verifying login success...")
            time.sleep(5)  # Wait for login to complete
            
            # You can add verification here
            # Example: Check if login successful by looking for home screen elements
